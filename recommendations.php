  	  		  	...
  	  		  	<div id="post-body" class="metabox-holder">
  	  		  	  <div id="postbox-container-2" class="postbox-container">
  	  		  	  	<div id="gallery_bank_get_started" class="postbox">
  	  		  	  		<h2 class="hndle">
  	  		  	  			<span><?php _e( "Get More Free Wordpress Plguins From WebHunt Infotech", 'PVGM_TEXT_DOMAIN' ); ?></span>
						</h2>
  	  		  	  		<div class="inside">
  	  		  	  									...
  	  		  	  									<div class="action-links">
  	  		  	  										<ul class="plugin-action-buttons-custom">
  	  		  	  											<li>
  	  		  	  												...
  	  		  	  												switch ( $plugin["slug"] ) {
  	  		  	  													case "photo-video-gallery-master" :
  	  		  	  														...
  	  		  	  														target="_blank">
  	  		  	  															<?php _e( "Premium Detail Page", 'PVGM_TEXT_DOMAIN' ); ?>
  	  		  	  														</a>
  	  		  	  														<a class="plugin-div-button install-now button"
  	  		  	  														href="http://demo.webhuntinfotech.com/demo?theme=pvgm-pro"
  	  		  	  														target="_blank">
  	  		  	  															<?php _e( "Demo Website", 'PVGM_TEXT_DOMAIN' ); ?>
  	  		  	  														</a>
  	  		  	  														<?php
  	  		  	  														break;
																	...
																	case "wp-login-page-customizer":
  	  		  	  														...
  	  		  	  														target="_blank">
  	  		  	  															<?php _e( "Buy Now", 'PVGM_TEXT_DOMAIN' ); ?>
  	  		  	  														</a>
  	  		  	  														<?php
  	  		  	  														break;
  	  		  	  												}
